 ...
 * wire the behaviour. On phones the tools collapse behind a single "⋯" overflow (design context §6 D3).
 * Pure + SSR — the static structure renders server-side and persists across SPA navigation.
 */
