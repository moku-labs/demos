 ...
 */
import { controllerPlugin, createApp, type Signaling, serverSignaling } from "@moku-labs/room";
 ...
 *   so the two apps pair in-process. Defaults to the deployed hub at `location.origin` — with which
 *   room 0.8+ ALSO defaults the whole ICE relay rung (a lazy fail-open fetch of the hub's
